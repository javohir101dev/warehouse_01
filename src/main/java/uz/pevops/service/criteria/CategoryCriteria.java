...
/**
 * Criteria class for the {@link uz.pevops.domain.Category} entity. This class is used
 * in {@link uz.pevops.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    public CategoryCriteria(CategoryCriteria other) {
        ...
        this.categoryParentId = other.categoryParentId == null ? null : other.categoryParentId.copy();
    ...
    public LongFilter categoryParentId() {
        if (categoryParentId == null) {
            categoryParentId = new LongFilter();
        }
        return categoryParentId;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, status, categoryParentId, distinct);
    }
