...
/**
 * Criteria class for the {@link uz.pevops.domain.Product} entity. This class is used
 * in {@link uz.pevops.web.rest.ProductResource} to receive all the possible filtering options from
...
public class ProductCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, status, code, photoId, measurementId, categoryId, distinct);
    }
