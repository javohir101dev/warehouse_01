...
import uz.pevops.repository.AttachmentRepository;
import uz.pevops.service.AttachmentQueryService;
import uz.pevops.service.AttachmentService;
import uz.pevops.service.criteria.AttachmentCriteria;
import uz.pevops.service.dto.AttachmentDTO;
import uz.pevops.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.pevops.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
public class AttachmentResource {
    ...
    private static final String ENTITY_NAME = "warehouse01Attachment";
    ...
    public ResponseEntity<List<AttachmentDTO>> getAllAttachments(
        ...
        log.debug("REST request to get Attachments by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countAttachments(AttachmentCriteria criteria) {
        log.debug("REST request to count Attachments by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
