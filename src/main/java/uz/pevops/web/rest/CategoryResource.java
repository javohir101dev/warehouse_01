...
import uz.pevops.repository.CategoryRepository;
import uz.pevops.service.CategoryQueryService;
import uz.pevops.service.CategoryService;
import uz.pevops.service.criteria.CategoryCriteria;
import uz.pevops.service.dto.CategoryDTO;
import uz.pevops.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.pevops.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "warehouse01Category";
    ...
    public ResponseEntity<List<CategoryDTO>> getAllCategories(
        ...
        log.debug("REST request to get Categories by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countCategories(CategoryCriteria criteria) {
        log.debug("REST request to count Categories by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
