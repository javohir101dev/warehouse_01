...
import uz.pevops.service.CurrencyQueryService;
import uz.pevops.service.CurrencyService;
...
/**
 * REST controller for managing {@link uz.pevops.domain.Currency}.
 */
@RestController
@RequestMapping("/api")
public class CurrencyResource {
    ...
    public ResponseEntity<List<CurrencyDTO>> getAllCurrencies(
        ...
        log.debug("REST request to get Currencies by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countCurrencies(CurrencyCriteria criteria) {
        log.debug("REST request to count Currencies by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
