...
import uz.pevops.service.UsersQueryService;
...
/**
 * REST controller for managing {@link uz.pevops.domain.Users}.
 */
@RestController
@RequestMapping("/api")
public class UsersResource {
    ...
    private static final String ENTITY_NAME = "warehouse01Users";
...
//    ) {
//        log.debug("REST request to get Users by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
...
//    }
    ...
    public ResponseEntity<Long> countUsers(UsersCriteria criteria) {
        log.debug("REST request to count Users by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
