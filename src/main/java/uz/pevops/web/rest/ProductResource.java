...
import uz.pevops.service.ProductQueryService;
import uz.pevops.service.ProductService;
...
/**
 * REST controller for managing {@link uz.pevops.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "warehouse01Product";
    ...
    public ResponseEntity<List<ProductDTO>> getAllProducts(
        ...
        log.debug("REST request to get Products by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countProducts(ProductCriteria criteria) {
        log.debug("REST request to count Products by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
