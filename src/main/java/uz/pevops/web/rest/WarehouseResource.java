...
import uz.pevops.service.WarehouseQueryService;
import uz.pevops.service.WarehouseService;
import uz.pevops.service.criteria.WarehouseCriteria;
import uz.pevops.service.dto.WarehouseDTO;
import uz.pevops.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.pevops.domain.Warehouse}.
 */
@RestController
@RequestMapping("/api")
public class WarehouseResource {
    ...
    private static final String ENTITY_NAME = "warehouse01Warehouse";
    ...
    public ResponseEntity<List<WarehouseDTO>> getAllWarehouses(
        ...
        log.debug("REST request to get Warehouses by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countWarehouses(WarehouseCriteria criteria) {
        log.debug("REST request to count Warehouses by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
