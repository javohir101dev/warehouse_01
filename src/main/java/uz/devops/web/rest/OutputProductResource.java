...
import uz.devops.service.OutputProductQueryService;
import uz.devops.service.OutputProductService;
...
/**
 * REST controller for managing {@link uz.devops.domain.OutputProduct}.
 */
@RestController
@RequestMapping("/api")
public class OutputProductResource {
    ...
    public ResponseEntity<OutputProductDTO> createOutputProduct(@Valid @RequestBody OutputProductDTO outputProductDTO)
    ...
    public ResponseEntity<OutputProductDTO> updateOutputProduct(
        ...
        @Valid @RequestBody OutputProductDTO outputProductDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<OutputProductDTO> partialUpdateOutputProduct(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody OutputProductDTO outputProductDTO
    ) throws URISyntaxException {
