...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).status(DEFAULT_STATUS).code(DEFAULT_CODE).amount(DEFAULT_AMOUNT);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).status(UPDATED_STATUS).code(UPDATED_CODE).amount(UPDATED_AMOUNT);
        return product;
    }
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsInShouldWork() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsNullOrNotNull() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsLessThanSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByAmountIsGreaterThanSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).status(UPDATED_STATUS).code(UPDATED_CODE).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).status(UPDATED_STATUS).code(UPDATED_CODE).amount(UPDATED_AMOUNT);
