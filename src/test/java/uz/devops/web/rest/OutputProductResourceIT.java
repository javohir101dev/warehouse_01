...
class OutputProductResourceIT {
    ...
    void checkAmountIsRequired() throws Exception {
        int databaseSizeBeforeTest = outputProductRepository.findAll().size();
        // set the field null
        outputProduct.setAmount(null);

        // Create the OutputProduct, which fails.
        OutputProductDTO outputProductDTO = outputProductMapper.toDto(outputProduct);
        ...
        List<OutputProduct> outputProductList = outputProductRepository.findAll();
        assertThat(outputProductList).hasSize(databaseSizeBeforeTest);
    }
